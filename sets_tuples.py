...
# for element in set1:
#     print(element)
# print(1 in set1) #output should be True
# print(6 in set1) #outputshould be False
# print(len(set1)) #output should be 5

# print("apple" in set3) #output should be true

# # add elements to a set
# set1.add(6)
# print(set1) #output should be {1, 2, 3, 4, 5, 6}
# set2.add("orange")
# print(set2)
# set3.add("grape")
# set3.add("kiwi")
...
# print(3 in set1) #output should be false
...
# #clear a set
# set1.clear()
# print(set1) #output should be set()
# id_numbers = {198798, 22345, 763653, 334444, 239585}
# #remove first element from the set
# id_numbers.pop()
# print(id_numbers) #output should be {198798, 22345, 763653, 334444, 239585}
# # addd a few more elements to the set using the add method 
...
data = { "fruits": {"tropical": ["mango", "pineapple", "banana"], "berries": ["strawberry", "blueberry", "raspberry"]},
